...
@pytest.mark.unit
def test_apply_min_position_property_always_apply(hass, mock_logger):
    """Test apply_min_position property returns False when enable_min_position = False."""
    # enable_min_position = False (min_pos_bool = False) → Always apply
    cover = AdaptiveVerticalCover(
        ...
        min_pos=35,
        max_pos_bool=False,
        min_pos_bool=False,  # enable_min_position = False
    ...
    # When enable_min_position = False, property should return False (always apply)
    assert cover.apply_min_position is False


@pytest.mark.unit
def test_apply_min_position_property_conditional(hass, mock_logger):
    """Test apply_min_position property returns True when enable_min_position = True."""
    # enable_min_position = True (min_pos_bool = True) → Conditional
    cover = AdaptiveVerticalCover(
        hass=hass,
        logger=mock_logger,
        sol_azi=180.0,
    ...
    # When enable_min_position = True, property should return True (conditional)
    assert cover.apply_min_position is True


@pytest.mark.unit
def test_apply_max_position_property_always_apply(hass, mock_logger):
    """Test apply_max_position property returns False when enable_max_position = False."""
    # enable_max_position = False (max_pos_bool = False) → Always apply
    cover = AdaptiveVerticalCover(
        hass=hass,
        logger=mock_logger,
        sol_azi=180.0,
        ...
        max_pos=60,
        min_pos=0,
        max_pos_bool=False,  # enable_max_position = False
        min_pos_bool=False,
        blind_spot_left=None,
        blind_spot_right=None,
        blind_spot_elevation=None,
    ...
    # When enable_max_position = False, property should return False (always apply)
    assert cover.apply_max_position is False


@pytest.mark.unit
def test_apply_max_position_property_conditional(hass, mock_logger):
    """Test apply_max_position property returns True when enable_max_position = True."""
    # enable_max_position = True (max_pos_bool = True) → Conditional
    cover = AdaptiveVerticalCover(
        hass=hass,
        logger=mock_logger,
        sol_azi=180.0,
        ...
        max_pos=60,
        min_pos=0,
        max_pos_bool=True,  # enable_max_position = True
        min_pos_bool=False,
        blind_spot_left=None,
        blind_spot_right=None,
        blind_spot_elevation=None,
    ...
    # When enable_max_position = True, property should return True (conditional)
    assert cover.apply_max_position is True
